...
class AssetBreakdownTest {
    ...
    void 순자산_0이면_roleAllocation_빈리스트_cashflowAssetRatio_null() {
        AssetBreakdown breakdown = breakdown(0, 0, 0, 0, 0, 0);
    ...
    void 자산은_있으나_현금흐름자산이_없으면_cashflowAssetRatio_0() {
        // 잠자는 돈 5천 + 성장 5천만, 현금흐름(비STOCK 보유·정기예금) 0.
        AssetBreakdown breakdown = breakdown(50_000_000, 0, 0, 0, 0, 50_000_000);
    ...
    void cashflowAssetRatio는_roleAllocation의_CASHFLOW_ratio와_항상_같다() {
        ...
        AssetBreakdown breakdown = breakdown(10_000_000, 0, 0, 10_000_000, 0, 10_000_000);
    ...
    void roleAllocation은_금액0역할_제외_선언순서유지_비율합100() {
        ...
        AssetBreakdown breakdown = breakdown(30_000_000, 10_000_000, 0, 30_000_000, 10_000_000, 30_000_000);
    ...
    private AssetBreakdown breakdown(long cash, long pensionCash, long pinnedSafe, long nonStock,
                                     long pensionHolding, long stock) {
        return new AssetBreakdown(won(cash), won(pensionCash), won(pinnedSafe),
                won(nonStock), won(pensionHolding), won(stock));
    }
