 ...
 *
 * ※ 안정형·안정추구형은 주식 비권유층이라 사실상 미발생. 도달하더라도 STEP5의 권유가능등급 필터
 *   (PortfolioAllocationCalculator.buildRiskHoldings#118)가 위험 ETF(2~3등급)를 전부 제거하므로
 *   NEUTRAL로 묶어도 무방하다 — 안정형/안정추구형은 위험버킷이 비고 안전+단기만 배분된다.
 */
